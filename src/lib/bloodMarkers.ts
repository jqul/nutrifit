...
export const BLOOD_MARKERS: BloodMarkerDef[] = [
  {
    key: 'glucosa', label: 'Glucosa (ayunas)', unit: 'mg/dL', min: 70, max: 99,
  ...
  {
    key: 'got_ast', label: 'GOT / AST (transaminasas)', unit: 'U/L', min: 5, max: 40,
    lowAdvice: '',
  ...
  {
    key: 'gpt_alt', label: 'GPT / ALT (transaminasas)', unit: 'U/L', min: 7, max: 56,
    lowAdvice: '',
    highAdvice: 'Transaminasas elevadas — valorar reducir grasas saturadas y azúcares (asociado a hígado graso); conviene confirmarlo con el médico.',
  },
  {
    key: 'hierro', label: 'Hierro', unit: 'µg/dL', min: 60, max: 170,
  ...
  {
    key: 'tsh', label: 'TSH', unit: 'µU/mL', min: 0.4, max: 4.0,
